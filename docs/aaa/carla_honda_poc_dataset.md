...
- `datasets/carla_honda_poc_aaa/videos/*.mp4`
- `datasets/carla_honda_poc_aaa/metadata/cars.csv`
- `datasets/carla_honda_poc_aaa/metadata/camera_graph.json`
- `datasets/carla_honda_poc_aaa/metadata/route_plan.json` (CARLA renderer)
- `datasets/carla_honda_poc_aaa/metadata/events.jsonl`
- `datasets/carla_honda_poc_aaa/annotations/bboxes.jsonl`
