...
- `datasets/carla_honda_poc_aaa2/videos/*.mp4`
- `datasets/carla_honda_poc_aaa2/metadata/cars.csv`
- `datasets/carla_honda_poc_aaa2/metadata/camera_graph.json`
- `datasets/carla_honda_poc_aaa2/metadata/route_plan.json` (CARLA renderer)
- `datasets/carla_honda_poc_aaa2/metadata/events.jsonl`
- `datasets/carla_honda_poc_aaa2/annotations/bboxes.jsonl`
