...
- `datasets/carla_honda_poc_realistic/videos/*.mp4`
- `datasets/carla_honda_poc_realistic/metadata/cars.csv`
- `datasets/carla_honda_poc_realistic/metadata/camera_graph.json`
- `datasets/carla_honda_poc_realistic/metadata/route_plan.json` (CARLA renderer)
- `datasets/carla_honda_poc_realistic/metadata/events.jsonl`
- `datasets/carla_honda_poc_realistic/annotations/bboxes.jsonl`
